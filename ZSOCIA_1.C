...
void main()
{
	...
	if(o==4)
	{
		...
		printf("\n------------------------------------------------------------------------------");
		displayfollower(queue);
		printf("\n\nAre you sure to Block any user from this list? (Y/N): ");
		scanf("%s",&bu);
			...
			{
			displayfollower(queue);
			printf("\n\tChoose your BLOCK id from your follower list or enter 0 to exit: ");
			scanf("%d",&b);
			if(b!=0);
			{
